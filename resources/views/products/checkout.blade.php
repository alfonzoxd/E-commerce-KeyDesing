        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gradient-to-br from-gray-900 to-black rounded-3xl p-6 shadow-2xl border border-red-500/20 sticky top-8">
                    ...
                    <a href="https://wa.me/+51983864192?text=Hola,%20estoy%20interesado%20en%20más%20información%20sobre%20el%20producto%20específico.%20¿Podrías%20darme%20más%20detalles?" target="_blank" class="w-full inline-flex items-center justify-center rounded-xl font-medium transition-all duration-300 transform hover:scale-105 active:scale-95 px-6 py-4 text-lg border-2 bg-transparent border-red-500 text-red-400 hover:bg-red-950/50 group mb-4">
