        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Botón de Asesoría Personalizada por WhatsApp -->
                    <div class="w-full">
                        <a href="https://wa.me/+51983864192?text=Hola,%20estoy%20interesado%20en%20más%20información%20sobre%20el%20producto%20{{ urlencode($product['name']) }}.%20¿Podrías%20darme%20más%20detalles?"
                           target="_blank"
                           class="inline-flex items-center justify-center w-full rounded-lg font-medium transition-all duration-200 transform hover:scale-105 active:scale-95 px-8 py-4 text-lg border-2 bg-transparent border-green-500 text-green-400 hover:bg-green-950/50 group">
                            <svg class="w-6 h-6 mr-3 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="font-semibold">Asesoría Personalizada</span>
